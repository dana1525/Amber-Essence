...
ALTER TABLE COCKTAILS
RENAME COLUMN timp_prep_min TO timp_prep;

INSERT into COCKTAILS (
  nume, descriere, timp_prep, volum_ml, categorie, tarie_alcoolica,
...
('Negroni', 'Cocktail clasic italian, amar și complex.', 7, 120, 'clasic', 22.0, 'scurt', 'gin', 
  '{"gin", "vermut roșu", "Campari", "coajă de portocală"}', true, false, 'negroni.jpg'),

('Gin Tonic', 'Combinație simplă și elegantă, răcoritoare, cu apă tonică.', 3, 250, 'răcoritor', 10.5, 'lung', 'gin', 
  '{"gin", "apă tonică", "lime", "gheață"}', true, true, 'gin_tonic.jpg'),

('Strawberry Daiquiri', 'Cocktail fructat și înghețat, perfect pentru vară.', 10, 300, 'tropical', 9.0, 'frozen', 'rom', 
...
('Blue Lagoon', 'Cocktail vibrant albastru, cu gust fructat și prospețime.', 12, 250, 'tropical', 11.0, 'lung', 'vodca', 
  '{"vodcă", "blue curaçao", "limonadă", "gheață"}', true, true, 'blue_lagoon.jpg'),

('Tequila Sunrise', 'Cocktail colorat și dulce, inspirat de un răsărit tropical.', 5, 200, 'tropical', 13.0, 'lung', 'tequila', 
  '{"tequila", "suc de portocale", "grenadină"}', true, true, 'tequila_sunrise.jpg'),

('Cosmopolitan', 'Elegant și ușor acrișor, potrivit pentru o seară sofisticată.', 4, 130, 'clasic', 16.0, 'fara gheata', 'vodca', 
  '{"vodcă", "triplu sec", "suc de merișor", "lime"}', true, true, 'cosmopolitan.jpg'),

('Mai Tai', 'Cocktail exotic, complex, pe bază de rom și migdale.', 6, 180, 'tropical', 17.5, 'scurt', 'rom', 
  '{"rom închis", "rom alb", "lime", "orgeat", "triplu sec"}', true, true, 'mai_tai.jpg'),

('Whisky Sour', 'Cocktail echilibrat, acrișor și corpolent, cu whisky.', 7, 150, 'clasic', 19.0, 'scurt', 'whisky', 
...
('B52', 'Shot stratificat cu trei lichioruri, perfect ca desert lichid.', 3, 60, 'de_petreceri', 26.0, 'in straturi', 'mix', 
...
('Virgin Mojito', 'Versiune fără alcool a clasicului Mojito, răcoritoare și fresh.', 8, 300, 'non-alcoolic', 0.0, 'lung', 'fără alcool', 
